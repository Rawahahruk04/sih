/**
 * AIPI Institutional TimeSeriesChart Component (ES Module)
 */
...
export class TimeSeriesChart {
  ...
  static render(container, props) {
    ...
    const yfmt = props.yFormat || ((v) => fmt.index(v, 1));
    ...
    const svgEl = container.querySelector('.time-series-svg');
