/**
 * AIPI Reusable Error State Component (ES Module)
 *
 * Single source of truth for the "failed to load" card every page renders
 * when its fetchData() call rejects. Consolidates what used to be seven
 * near-identical copies of this markup across the page modules.
 */
