/**
 * AIPI Screen 2: Route Analytics & Sector Intelligence (ES Module)
 */
...
export class RouteAnalyticsPage {
  ...
  renderContent() {
    ...
    const heatmapCanvas = page.querySelector('#sector-heatmap-canvas');
  ...
  attachFilterListeners(page) {
    const searchInput = page.querySelector('#route-search-input');
