        ...
        <div class="card-container">
          <div class="card-header">
            ...
            <div class="segmented-control" id="window-filter-control" role="tablist" aria-label="Window Filter">
              ...
              <button class="segmented-control-item ${this.selectedWindowDays === refWindow ? 'active' : ''}" data-window="${refWindow}" role="tab" aria-selected="${this.selectedWindowDays === refWindow}">T+${refWindow} Ref</button>
